...
namespace Persistence.Migrations
{
    ...
    [Migration("20220312172633_RefreshTokenAdded")]
            ...
            modelBuilder.Entity("Domain.Accounts.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Currency = "USD",
                            UserId = "df1525ce-1f1b-4e22-81fd-1065a35e4d5c"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Credits.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("352e98c4-f68b-4175-a943-08ab46b9c01b"),
                            Currency = "USD",
                            TransactionDate = new DateTime(2022, 3, 12, 17, 26, 33, 508, DateTimeKind.Utc).AddTicks(2695),
                            Value = 400m
                        });
                });
            ...
            modelBuilder.Entity("Domain.Debits.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("352e98c4-f68b-4175-a943-08ab46b9c01b"),
                            Currency = "USD",
                            TransactionDate = new DateTime(2022, 3, 12, 17, 26, 33, 508, DateTimeKind.Utc).AddTicks(2713),
                            Value = 50m
                        });
                });
