...
public class DeviceController : Controller
{
    ...
    public DeviceController(IEventService events, IDeviceFlowInteractionService interaction, ILogger<DeviceController> logger, IOptions<IdentityServerOptions> options)
    {
        _events = events;
